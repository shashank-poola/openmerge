...
2. Authorize OpenMerge and select the repositories to review.
3. Open a pull request — OpenMerge will post a review automatically.

## Configuration

Add a `.openmerge.yml` file to the root of your repository:
